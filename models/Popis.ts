export class Popis {
    ...
    private datum: Date;
    private kuhinja: number;
    private kuhinjaSt: number;
    private wolt: number;
    private glovo: number;
    private sale: number;
    private ostalo: number;
    private ostaloOpis: string;
    private virman: number;
    private virmanOpis: string;
